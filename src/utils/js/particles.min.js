  ...
  return (
    ...
    (n.prototype.pauseAnimation = function () {
      ...
      if (t._animation) {
        if (t.usingPolyfill) e.clearTimeout(t._animation);
          ...
          (e.cancelAnimationFrame || e.webkitCancelAnimationFrame || e.mozCancelAnimationFrame)(
            t._animation,
          );
        t._animation = null;
      }
    ...
    (n.prototype._draw = function () {
      var t = this,
        ...
        s = t.storage;
      n.offsetParent && 'BODY' === n.offsetParent.nodeName && (r = e.innerHeight),
    ...
    ((i = function (n, i) {
      ...
      (o.x = l.offsetParent ? r() * l.offsetParent.clientWidth : r() * l.clientWidth),
        l.offsetParent && 'BODY' === l.offsetParent.nodeName
          ? (o.y = r() * e.innerHeight)
          : (o.y = l.offsetParent ? r() * l.offsetParent.clientHeight : r() * l.clientHeight),
        (o.vx = r() * a * 2 - a),
        (o.vy = r() * a * 2 - a),
